  ...
  <div class="header-content">
    ...
    <div class="center">
      <form class="search-form" action="/search" method="get">
        ...
        <button type="submit" class="search-btn" aria-label="Buscar">
          <img src="/src/assets/images/search.svg" alt="Buscar" />
        </button>
      </form>
    </div>
    ...
    <div class="right">
      <a href="/help" class="action">
        <img src="/src/assets/images/circle-question-mark.svg" alt="Ayuda">
        <span>Ayuda</span>
      </a>
      <a href="/cart" class="action">
        <img src="/src/assets/images/shopping-cart.svg" alt="Carrito">
        <span>Carrito</span>
      </a>
      <a href="/profile" class="action">
        <img src="/src/assets/images/user.svg" alt="Mi cuenta">
        <span>Mi cuenta</span>
      </a>
    </div>
  </div>
